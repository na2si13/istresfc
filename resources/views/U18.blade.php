            ...
            <hr class="bgColorYellow col-4 mb-3">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item col-6 col-lg-4">
                      <a class="nav-link p-0 mb-2" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">
                        <button type="button" class="btn btn-light btnCouleur col-12">Classement</button>
                      </a>
                    </li>
                    <li class="nav-item col-6 col-lg-4">
                      <a class="nav-link p-0 mb-2" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
                        <button type="button" class="btn btn-light btnCouleur col-12">Calendrier</button>
                      </a>
                    </li> 
                    <li class="nav-item col-6 col-lg-4 mx-auto">
                            <a class="nav-link p-0 mb-2" id="equipe-tab" data-toggle="tab" href="#equipe" role="tab" aria-controls="equipe" aria-selected="false">
                          ...
                          <img src="storage/{{ $equipe->photo }}" class="card-img mt-3 col-12" alt="...">
                            ...
                            @foreach($attaquants as $attaquant)
                              <div class="card bgColorViolet colorJaune CouleurArticle col-lg-2 col-md-4 col-10 mt-4 ml-2">
                                  ...
                                  {{ $attaquant->prenom }}<hr class="m-0 bgColorYellow">
                                  {{ $attaquant->poste}}<br>
                                  {{ $attaquant->annee }}</p>
                                </div>
                              @endforeach
                              </div>
                              <div class="col-12 row mx-auto justify-content-around">                              @foreach($defenseurs as $defenseur)
                              <div class="card bgColorViolet colorJaune CouleurArticle col-lg-2 col-md-4 col-10 mt-4 ml-2">
                              ...
                              <div class="col-12 row mx-auto justify-content-around">                              @foreach($millieux as $millieu)
                              <div class="card bgColorViolet colorJaune CouleurArticle col-lg-2 col-md-4 col-10 mt-4 ml-2">
                              ...
                              <div class="col-12 row mx-auto justify-content-around">                              @foreach($gardiens as $gardien)
                              <div class="card bgColorViolet colorJaune CouleurArticle col-lg-2 col-md-4 col-10 mt-4 ml-2">
                 ...
                 @foreach($articles as $article)
                  <div class="card col-lg-5 col-sm-10 col-md-5 mr-2 mx-auto mt-3 mb-3 bgTransparent colorViolet contour bgColorGris" style="width: 18rem;"  data-aos="flip-left">
                    ...
                    <div class="card-body">
                      ...
                      <a href="{{ URL::action('HomeController@afficheArticle', $article->id) }}" class="btn btn-light btnCouleur">Lire l'article</a>
                    </div>
                  </div>
                  @endforeach
                 </article>
