        ...
        <div class="bd-example mb-5 mt-3 contour1" data-aos="fade-down">
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner contour1">
                <div class="carousel-item active">
                  <img src="./img/testcarousel.jpg" class="w-100" alt="...">
                ...
                <div class="carousel-item">
                  <img src="./img/equipeU17.jpg" class="d-block w-100" alt="...">
                  <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                  <img src="./img/imgstade2.jpg" class="d-block w-100" alt="...">
                  <div class="carousel-caption d-none d-md-block">
          ...
          <section class="col-12 contour colorViolet" data-aos="fade-up"> 
            ...
            @foreach($prochrencontres as $prochrencontre)  
              <img class="col-5 text-center p-0" src="storage/{{ $prochrencontre->logodom }}" alt="equipe domicile">
                <h5 class="col-2 p-0 text-center mt-5 font-weight-bold">VS</h5>
                <img class="col-5 text-center p-0" src="storage/{{ $prochrencontre->logoext }}" alt="equipe exterieur">
            </div>   
            <h4 class="text-center mt-2">{{ $prochrencontre->date }}<br>{{ $prochrencontre->heure }}</h4> 
            <hr class="bgColorYellow col-4 mb-3">
            <h4 class="text-center pb-3">{{ $prochrencontre->stade }} <br> {{ $prochrencontre->codepostal }} {{ $prochrencontre->ville }}</h4>
            @endforeach
          </section>
            ...
            <hr class="bgColorYellow col-4 mb-3">
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item col-6">
                    <a class="nav-link p-0" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">
                      <button type="button" class="btn btn-light  col-12 btnCouleur">Classement</button>
                    </a>
                  </li>
                  <li class="nav-item col-6">
                    <a class="nav-link p-0" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
...
<!-- ------------------------------------------------------------------------ -->
                  ...
                  <!-- TABLEAU CALENDRIER -->
                  <div class="tab-pane fade text-center" id="profile" role="tabpanel" aria-labelledby="profile-tab"><table class="table">
                      <h3>Calendrier</h3>
                      <hr class="bgColorYellow col-4">
                      <thead class="bgColorViolet colorJaune">
                        <tr>
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
          <div class="row">
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoConseil.jpg"
                  alt="Card image cap">
              </div>
            </div>
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoIstres.png"
                  alt="Card image cap">
              </div>
            </div>
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
            ...
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoSamalu.jpg"
                  alt="Card image cap">
              </div>
            </div>
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoEntrepot.jpg"
                  alt="Card image cap">
              </div>
            </div>
          </div>
        ...
        <div class="carousel-item">
          <div class="row">
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoLeclerc.jpg"
                  alt="Card image cap">
              </div>
            </div>
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoMistral.jpg"
                  alt="Card image cap">
              </div>
            </div>
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoSimc.png"
                  alt="Card image cap">
              </div>
            </div>
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
              <div class="card mb-2">
                <img class="card-img-top" src="./img/logoTaxi.jpg"
                  alt="Card image cap">
              </div>
            </div>
            <div class="col-4 col-lg-2 col-md-3 mx-auto">
...
<!-- SECTION RAPPEL DES PAGES DU SITE AVEC LOGO DU CLUB-->
            ...
            <section class="text-center col-sm-12 col-md-12 col-lg-4">
                ...
                <ul class="list-group list-group-horizontal">
                    ...
                    <li class="list-group-item col-6 mt-2 bgTransparent"><a class="colorViolet" href="">Mention Légales</li></a>
                </ul>
                <i class="fab fa-facebook-square mt-5 mx-auto col-12 text-center"><a href=""> Suivez notre actualité aussi sur Facebook</a></i>
            </section>
