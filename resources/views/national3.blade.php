        ...
        <div class="tab-pane" id="equipe" aria-labelledby="equipe-tab">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="bgColorViolet colorJaune  col-lg-4 col-md-5 mb-2 col-10 mx-auto">
                            <h2>Entraineur</h2>
                            <img src="storage/{{ $entraineur->photo }}" class="card-img imgJoueur" alt="photo de l'entraineur">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <img src="storage/{{ $equipe->photo }}" class="card-img mt-3 col-12" alt="photo de l'équipe">
                    @endforeach
                </div>
            </div>
